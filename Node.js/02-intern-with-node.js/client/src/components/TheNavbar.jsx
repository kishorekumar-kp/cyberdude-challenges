const TheNavbar = () => {
  return (
    <div className="bg-beige flex justify-between px-40 items-center p-4 text-light">
      <h1 className="text-2xl items-center">Interns-card</h1>
      <div>
        <a href="https://github.com/kishorekumar-kp/cyberdude-challenges/tree/main/Node.js/02-intern-with-node.js" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="2rem"
            height="2rem"
            viewBox="0 0 20 20"
            className="items-center hover:text-dark"
            href="https://github.com/kishorekumar-kp/cyberdude-challenges/tree/main/Node.js/02-intern-with-node.js"
          >
            <path
              fill="currentColor"
